...
HD_PWD='C:/FPGA/machine_arm/machine_arm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log machine_arm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source machine_arm.tcl -notrace
