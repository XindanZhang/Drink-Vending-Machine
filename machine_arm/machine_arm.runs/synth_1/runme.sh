...
HD_PWD='C:/FPGA/machine_arm/machine_arm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log machine_arm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source machine_arm.tcl
